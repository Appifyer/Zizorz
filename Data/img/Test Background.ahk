...
; Show the window
ScreenCenter := A_ScreenWidth/2-300
ScreenBottom := A_ScreenHeight - 164
Gui, 1: Show, x%ScreenCenter% y30

; Get a handle to this window we have created in order to update it later
hwnd1 := WinExist()

; If the image we want to work with does not exist on disk, then download it...
If !FileExist("zizorz2 bg.png")
UrlDownloadToFile, http://www.autohotkey.net/~tic/background.png, background.png

; Get a bitmap from the image
pBitmap := Gdip_CreateBitmapFromFile("zizorz2 bg.png")
...
UpdateLayeredWindow(hwnd1, hdc, ScreenCenter, ScreenBottom, Width, Height)
